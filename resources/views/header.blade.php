<div id="header">
        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a href="{{route('lienhe')}}"><i class="fa fa-home"></i> 68 Dịch Vọng hậu, Cầu Giấy, HN</a></li>
                    <li><a href="{{route('lienhe')}}"><i class="fa fa-phone"></i> 0976 014 798</a></li>
                </ul>
            </div>
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo-cake.png"
                                                                width="200px" alt=""></a>
            </div>
                ...
                <div class="beta-comp">
                        ...
                        <div class="cart">
                            ...
                            <div class="beta-dropdown cart-body">
                                ...
                                @foreach($product_cart as $product)
                                    <div class="cart-item">
                                        <a class="cart-item-delete"
                                           href="{{route('xoagiohang',$product['item']['id'])}}" s><i
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span
                                                    class="cart-item-amount">{{$product['qty']}}*<span>@if($product['item']['promotion_price']==0){{$product['item']['unit_price']}} @else {{$product['item']['promotion_price']}}@endif đồng </span></span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="cart-caption">
                                    <div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{Session('cart')->totalPrice}} đồng</span>
                                    </div>
                                    <div class="clearfix"></div>
                    ...
                    @else
                        <div class="cart">
                            ...
                            <div class="beta-dropdown cart-body">
                                <div class="cart-caption">
                                    <span>Đã mua gì đâu mà ấn vào giỏ hàng, ngáo à?</span>
                                </div>
                            </div>
                        </div> <!-- .cart -->
                    @endif
