								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}"><img src="source/image/product/{{$new->image}}" alt="" style="height: 215px;"></a>
										</div>
							...
							<div class="row">
								...
								<div class="col-sm-3" style="margin-bottom: 30px">
									<div class="single-item">
										...
										@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" style="height: 215px;"></a>
										</div>
										<div class="single-item-body">
